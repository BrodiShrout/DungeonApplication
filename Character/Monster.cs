...
namespace LibarayOfDoom
{
    public class Monster : Character
    {
        ...
        public static Monster GetMonster()
        {
            ...
            Oni m8 = new("Hatamoto Samuri", hitChance: 45, block: 24, maxLife: 49, maxDamage: 19, minDamage: 10, description: "A high ranking samuri who now romes the earth as a verngful spirit who is ready to fight anyone and everyone he comes across.", isCalm: true, weaponDrop: WeaponTypes.Katana);
